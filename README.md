...
- `scripts/04_age_related_acoustic_analysis/03_traditional_score_adjusted_sensitivity.py`
...
These results correspond to Table S8.
...
python scripts/04_age_related_acoustic_analysis/03_traditional_score_adjusted_sensitivity.py
