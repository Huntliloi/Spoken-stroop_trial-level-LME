# Spoken Stroop Item-Level Speech Phenotyping

This repository provides the task materials, English-language analysis code,
anonymized feature data, and statistical results for:

**An Automated Item-Level Acoustic Extension of the Spoken Stroop: Feature
Repeatability, Age Sensitivity, and Clinical Applicability**
...
### 7. Behavioral and Acoustic Model Comparison

The final clinical comparison uses six age-referenced conventional measures
(accuracy and total hesitation duration for each task), four acoustic
deviation indices, and their combination. Predictions are generated with
leave-one-subject-out cross-validated L2 logistic regression; AUC confidence
intervals use DeLong's method.
