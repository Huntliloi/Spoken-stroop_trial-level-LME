...
This repository contains the task materials, public code, anonymized feature
data, and result tables for the manuscript:

**An Automated Trial-Level Acoustic Extension of the Spoken Stroop: Reliability, Age Sensitivity, and Clinical Applicability**
...
```text
task_materials/                    Task instructions and stimulus screens
...
`task_materials/` contains the original Mandarin instruction and stimulus
screens used in the experiment. The numbered PNG files follow the experimental
sequence:

- `1.png`: task instructions
- `2.png`: Hanzi-reading baseline
- `3.png`: color-dot naming baseline
- `4.png`: Stroop practice
- `5.png`: Stroop test

The Mandarin text and color-word stimuli are retained because they are part of
the experimental materials rather than repository documentation.
