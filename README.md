...
healthy-reference deviation results corresponding to Table 3 are under
...
- `results/05_substance_use_external_validation/table4_moca_correlations.csv`
- `results/05_substance_use_external_validation/table_s12_drug_vs_hc.csv`
- `results/05_substance_use_external_validation/table_s13_moca_groups.csv`
