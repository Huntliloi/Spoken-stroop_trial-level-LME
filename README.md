...
stable. These results correspond to Table 2 and Tables S9-S11.
...
- `results/05_substance_use_external_validation/table_s12_moca_groups_by_condition.csv`
- `results/05_substance_use_external_validation/table_s13_drug_vs_hc_by_condition.csv`
...
source for Figure 7. Script 04 reproduces the scores, Tables 4/S12/S13, and
