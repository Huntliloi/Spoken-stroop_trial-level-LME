"""Build manuscript Tables 3, S8, and S9 from feature-level ICC results."""
...
def build_table_s9() -> pd.DataFrame:
    all3 = pd.read_csv(input_path("cross_device_all3_overall.csv"))
    return all3.loc[
...
def main() -> None:
    ...
    outputs = {
        "table3_within_device_retest_summary.csv": build_table3(),
        "table_s8_cross_device_summary.csv": build_table_s8(),
        "table_s9_cross_device_features_icc_ge_0_50.csv": build_table_s9(),
    }
