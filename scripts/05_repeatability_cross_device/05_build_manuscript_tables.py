"""Build manuscript Table 2 and Tables S10-S11 from feature-level ICC results."""
...
def build_table_s10() -> pd.DataFrame:
...
def build_table_s11() -> pd.DataFrame:
    all3 = pd.read_csv(input_path("cross_device_all3_overall.csv"))
    return all3.loc[
...
def main() -> None:
    ...
    outputs = {
        "table2_within_device_retest_summary.csv": build_table2(),
        "table_s10_cross_device_summary.csv": build_table_s10(),
        "table_s11_cross_device_features_icc_ge_0_50.csv": build_table_s11(),
    }
