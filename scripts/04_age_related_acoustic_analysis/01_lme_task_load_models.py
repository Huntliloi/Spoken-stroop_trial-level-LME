...
COMPARISON_CONFIG = {
    "CW_vs_W": {
        "tasks": ["W", "CW"],
        "task_code_map": {"W": 0, "CW": 1},
        "base_task": "W",
        "contrast_task": "CW",
        "output_file": "plot_paper_CW_vs_W.csv",
        "plot_dir": "result_LME_CW_vs_W",
        "interference_label": "Stroop Interference (CW-W)"
    },
    "CW_vs_C": {
        "tasks": ["C", "CW"],
        "task_code_map": {"C": 0, "CW": 1},
        "base_task": "C",
        "contrast_task": "CW",
        "output_file": "plot_paper_CW_vs_C.csv",
        "plot_dir": "result_LME_CW_vs_C",
        "interference_label": "Stroop Interference (CW-C)"
    },
    "C_vs_W": {
        "tasks": ["W", "C"],
        "task_code_map": {"W": 0, "C": 1},
        "base_task": "W",
        "contrast_task": "C",
        "output_file": "plot_paper_C_vs_W.csv",
        "plot_dir": "result_LME_C_vs_W",
        "interference_label": "Stroop Interference (C-W)"
    }
}
    ...
    for i, feature in enumerate(run_list):
        ...
        try:
            ...
            try:
                ...
                print(
                    f"      [{cfg['contrast_task']}] Age effect (t-test): Coef: {coef_contrast:.3f}, P-value: {p_val_contrast_str} {'*' if is_sig_contrast else ''}")

            except Exception as test_e:
                print(f"      [Warning] t-test failed ('{test_e}'); switching to manual calculation...")
                try:
