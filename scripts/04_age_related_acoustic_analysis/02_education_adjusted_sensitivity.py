...
STT-versus-Hanzi contrast. It compares the original model
...
DEFAULT_ORIGINAL_SUMMARY_PATH = (
    ...
    / "LME_deviation_scores_STT_vs_Hanzi_WD_CI_FDR01"
    / "healthy_LME_model_summary_STT_vs_Hanzi_WD_CI_FDR01.csv"
)

TASKS = ("Hanzi", "STT")
TASK_CODE = {"Hanzi": 0, "STT": 1}
...
Purpose
Assess whether the 25 prespecified STT-versus-Hanzi Age x Task effects remain stable after controlling for education in the 158-person healthy cohort.
...
Definitions
1. Hanzi is coded 0 and STT is coded 1.
2. Age and education are Z-standardized across the 158 unique healthy participants using population SD (ddof=0).
3. Each acoustic feature is Z-standardized across the included STT and Hanzi item-level observations.
