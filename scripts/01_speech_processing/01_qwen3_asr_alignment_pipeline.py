...
if USE_GUI_FOLDER_PICKER:
    ...
    root = tk.Tk()
    root.withdraw()
    chosen_audio = filedialog.askdirectory(title='English documentation.')
    if chosen_audio:
        AUDIO_ROOT = chosen_audio
    chosen_output = filedialog.askdirectory(title='English documentation.')
    if chosen_output:
...
# Utilities
# =========================
COLORS = ['English documentation.', 'English documentation.', 'English documentation.', 'English documentation.']
...
def main():
    ...
    for wav_path in tqdm(wav_files, desc='English documentation.'):
