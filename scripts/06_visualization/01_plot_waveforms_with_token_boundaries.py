...
SUBJECT_FILTER = ["20220929006", "20231123169"]
# SUBJECT_FILTER = None
...
def infer_audio_path(subject_id: str, task: str, audio_root: str) -> Optional[Path]:
    '\n                ：\n    E:/.../audio/<subject_folder>/session_1/04_Stroop/<subject_id>_stroop_<task>.wav\n\n       subject_folder   subject_id   ，  ：\n    202211212047_20220928002\n    '
...
def make_token_label(row: pd.Series) -> str:
    ...
    color_to_letter = {
        'English documentation.': "R",
        'English documentation.': "Y",
        'English documentation.': "B",
        'English documentation.': "G",
    }
...
def main():
    ...
    token_idx_col = find_first_existing_col(df, ["token_index", "trial_index", "idx"])
