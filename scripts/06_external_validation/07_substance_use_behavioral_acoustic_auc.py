...
12. Full-sample analyses count missing recognized items as errors and impute missing completion-time predictors within each training fold. Complete-case analyses include only participants with 12 paired items in both W and CW.
"""
