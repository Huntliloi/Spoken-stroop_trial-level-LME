...
def load_acoustic_scores(score_path: Path) -> pd.DataFrame:
    ...
    return scores[columns + ACOUSTIC_COLUMNS]
...
7. BH correction is applied separately within each analysis set across the six traditional Stroop tests and the six acoustic tests.
...
12. Missing recognized items count as errors, and missing completion-time predictors are median-imputed within each training fold.
"""
