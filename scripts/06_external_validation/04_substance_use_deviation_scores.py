...
This script follows S.2_compute_WD_LME_deviation_scores_STT_vs_Hanzi.py,
but scores new Drug/HC subjects with trial-level LME random-slope BLUPs:
  ...
  4. Estimate each Drug/HC subject's Task_Code random slope from all item-level
     STT/Hanzi trials using the healthy LME variance structure.
