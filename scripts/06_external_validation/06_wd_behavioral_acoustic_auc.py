...
def load_wd_data(
    ...
    specifications = [
        (
            ...
            WD_RESULT_DIR / "LME_deviation_scores_CW_vs_W_WD_CI_FDR01"
            / "WD_subject_level_deviation_index_CW_vs_W_WD_CI_FDR01.csv",
        ),
        (
            "WD-CN",
            PUBLIC_WD_FEATURE_DIR / "Stroop_features_WD_CN.csv",
            WD_RESULT_DIR / "LME_deviation_scores_CW_vs_W_WD_CN_FDR01"
            / "WD_subject_level_deviation_index_CW_vs_W_WD_CN_FDR01.csv",
        ),
    ]
...
def univariate_group_comparison(subject_data: pd.DataFrame) -> pd.DataFrame:
    ...
    for analysis_set, subset in [
        ...
        ("Complete 12 items in W and CW", subject_data[subject_data["QC_W_CW_Complete_12"]].copy()),
    ]:
...
11. Full-sample analyses count missing recognized items as errors and impute missing completion-time predictors within each training fold. Complete-case analyses include only participants with 12 paired items in both W and CW.
"""
