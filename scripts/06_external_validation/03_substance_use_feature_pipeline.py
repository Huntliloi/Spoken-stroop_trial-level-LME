"""Extract trial-level Stroop features for the substance-use cohort.

This script follows S.1_recovered_WD_stroop_pipeline_add.py.py step by step:
  1. Qwen3 ASR + forced alignment + boundary refinement.
  2. Build word-level Stroop segment table from token_results.csv.
  3. Write word-level wav segments.
